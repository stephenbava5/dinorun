...
export class DinoChaser {
    constructor(scene, initialLane, z) {
        this.scene = scene;
        this.lane = 1;
        this.position = new Vector3(-2, 0, 10);
    ...
    update(playerLane, playerSpeed, catchLevel = 0) {
    ...
    isNearPlayer(playerZ) {
        return Math.abs(playerZ - this.position.z) < 1.5;
    }
}
//# sourceMappingURL=DinoChaser.js.map